...
%root_dir = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/analysis2/postvOT_mask_topvoxels_ROIs/'; % your individual ROI paths
root_dir = '/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/analysis2/antvOT_mask_topvoxels_ROIs/';
subjects = {};
...
%roi_name= 'postvOT_mask_onset_vs_rhyme_ses-5_p1_k100_adjust_mask.nii';
roi_name= 'antvOT_mask_rhyme_vs_onset_ses-7_p1_k100_adjust_mask.nii';
...
cd(root_dir);
%save_nii(s,'combined_ROIs_postvOT_mask_onset_vs_rhyme_ses5.nii')  % The name of your combined ROI
save_nii(s,'combined_ROIs_antvOT_mask_rhyme_vs_onset_ses7.nii')
