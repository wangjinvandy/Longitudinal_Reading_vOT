...
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/scripts_to_share/3firstlevel')); % the path of your scripts
...
analysis_folder='analysis_s4'; % the name of your first level modeling folder
...
conditions{3}={'P_C' 'P_O' 'P_R' 'P_U'};
conditions{4}={'P_C' 'P_O' 'P_R' 'P_U'};
...
contrasts={'onset_vs_perc_ses-5' ...
    ...
    'onset_vs_rhyme_ses-7' ...
    'rhyme_vs_onset_ses-7'};
...
weights={[onset_vs_per rp_w onset_vs_per rp_w empty empty] ...
    ...
    [rhyme_vs_onset rp_w rhyme_vs_onset rp_w empty empty] ...
    [empty empty onset_vs_rhyme rp_w onset_vs_rhyme rp_w] ...
    [empty empty rhyme_vs_onset rp_w rhyme_vs_onset rp_w]};
