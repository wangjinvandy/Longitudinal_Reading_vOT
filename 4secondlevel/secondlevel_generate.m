...
addpath(genpath('/dors/booth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/scripts_to_share/4secondlevel')); % the path of your scripts
...
out_dir = '/dors/booth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/secondlevel'; % your output folder of secondlevel analysis results
