...
roi_file_root = '/dors/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/analysis3/s4_sphere_8--36_-68_-12_mask_topvoxels_ROIs/';

% make sure the scriptdir is in the path
addpath(pwd);

roi_is_image=1; % 0 if the image is "_roi.mat", 1 if the image is ".nii"; 
namerois = {'sphere_8--36_-68_-12_mask_onset_vs_rhyme_ses-7_p1_k100_adjust_mask' }; 
...
PPI_folder = 'analysis_ses5_s4/deweight/PPI_VOI_postSTG_onset7_vs_rhyme_gPPI';
