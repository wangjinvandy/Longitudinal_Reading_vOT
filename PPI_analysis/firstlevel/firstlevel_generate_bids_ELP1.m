...
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/scripts_to_share/PPI_analysis/firstlevel')); % the path of your scripts
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp'; %the path of spm
addpath(genpath(spm_path));

%define your data path
data=struct();
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7';  %your project path
subjects={};
...
analysis_folder='analysis_ses5_s4'; % the name of your first level modeling folder
...
CCN.session='ses-5'; % the time points you want to analyze
CCN.func_pattern='sub*'; % the name of your functional folders
CCN.file='vs4_wsub*bold.nii'; % the name of your preprocessed data (4d)
...
%matched.
contrasts={'onset_vs_perc_ses-5' ...
    'rhyme_vs_perc_ses-5' ...
    'expt_vs_perc_ses-5' ...
    'onset_vs_rhyme_ses-5' ...
    'rhyme_vs_onset_ses-5'};


onset_vs_per=[-1 1 0 0];
rhyme_vs_per=[-1 0 1 0];
expt_vs_perc=[-2 1 1 0];
onset_vs_rhyme=[0 1 -1 0];
rhyme_vs_onset=[0 -1 1 0];

%adjust the contrast by adding six 0s into the end of each session
rp_w=zeros(1,6);
empty=zeros(1,10);
weights={[onset_vs_per rp_w onset_vs_per rp_w] ...
    [rhyme_vs_per rp_w rhyme_vs_per rp_w] ...
    [expt_vs_perc rp_w expt_vs_perc rp_w]...
    [onset_vs_rhyme rp_w onset_vs_rhyme rp_w] ...
    [rhyme_vs_onset rp_w rhyme_vs_onset rp_w]};
