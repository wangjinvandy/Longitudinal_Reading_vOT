...
%%within run(session) or across runs(session).

% Parameter Structure/File Containing Parameter Structure with the following fields:
addpath('/dors/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7/scripts_to_share/PPI_analysis/PPPIv13');
addpath('/dors/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp');
subjects={'sub-5242' 'sub-5259' 'sub-5286' 'sub-5304' 'sub-5338' 'sub-5342' 'sub-5344' 'sub-5352'};
...
root='/dors/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/ReadingvOT_5_7';
datafolder='preproc';
model_dir='analysis_ses7_s4/deweight';
VOIref='indiv_mask'; %or group_mask
seedregion='postSTG_rhyme7_vs_onset'; %'sphere_avOT_rhyme7'; %antvOT_rhyme is for rhyme>perc, antvOT_onset is for onset>perc
ROI_folder='analysis5/postSTG_topvoxels_ROIs'; %'analysis3/s4_sphere_8--46_-53_-20_mask_topvoxels_ROIs';
ROI_name='postSTG_rhyme_vs_onset_ses-7_p1_k100_adjust_mask.nii'; %'sphere_8--46_-53_-20_mask_rhyme_vs_onset_ses-7_p1_k100_adjust_mask.nii';
...
for num=1:length(subjects)
    ...
    %               directory.
    P.directory=[root '/' datafolder '/' subjects{num} '/' model_dir];
    cd(P.directory);
